...
###################################################################################################
    ...
    def advanced_config_menu():
        ...
        if advanced_config == True :
            ...
            return ui.card( 
                            ui.input_select("surrogate_config", "Select the surrogate function", {"Default":"Default", "GP":"Guassian Process", "MixedGP":"Mixed Gaussian Process", "DKL":"Deep Kernel Learning", "GPFlat":"GP without Priors", "MTGP":"Multi Task Gaussian Process", "DNN":"Dropout Neural Network"}),
